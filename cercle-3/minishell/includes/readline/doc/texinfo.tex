...
% Explicit font changes: @r, @sc, undocumented @j.
\def\r#1{{\rm #1}}              % roman font
\def\sc#1{{\smallcaps#1}}       % smallcaps font
\def\j#1{{\it #1}}             % italic font
...
\gdef\finishentry#1{%
    ...
    \global\setbox\entryindexbox=\vbox\bgroup\noindent
      ...
      %
      \dimen@j = \hsize
      \advance\dimen@j by -1\leftskip
      \advance\dimen@j by -1\entryrightmargin
      \advance\dimen@j by 1\dimen@i
      \let\maybestrut=\relax
      \ifdim\wd\boxA > \dimen@j % If the entry doesn't fit in one line
        \let\maybestrut=\strut
      \ifdim\dimen@ > 0.8\dimen@j   % due to long index text
        \dimen@ = 0.7\dimen@ % Try to split the text roughly evenly
        \dimen@j = \hsize
        \advance \dimen@j by -1em
        \ifnum\dimen@>\dimen@j
        ...
        \parshape = 2 0pt \dimen@ 1em \dimen@j
